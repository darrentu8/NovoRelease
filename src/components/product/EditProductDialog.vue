...
const initData = () => {
  data.id = productStore.currentProduct.id
  data.appid = productStore.currentProduct.appid
  data.name = productStore.currentProduct.name
  data.cdn = productStore.currentProduct.cdn
}
const editProduct = () => {
  Form.value.validate().then(success => {
    if (success) {
      ...
      productStore.editProduct(Data).then(() => {
        hideDialog()
      })
    }
  })
