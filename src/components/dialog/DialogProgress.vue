  ...
  <q-dialog :model-value="isShow" @before-hide="hideDialog">
    <q-card class="text-center brand-dialog-round q-pa-lg no-scroll"
      ...
      <q-card-section v-if="props.progressVal === 1" class="row flex justify-center items-center q-pb-none">
        <q-icon name="cloud_upload" color="primary" :size="!$q.platform.is.mobile ? '3vw' : '36px'" />
      </q-card-section>
      ...
      <q-card-section v-if="props.progressVal < 1" class="row q-pb-sm items-center">
        <q-linear-progress animation-speed="300" rounded size="15px" :value="props.progressVal" color="primary"
          class="q-mt-sm brand-round">
