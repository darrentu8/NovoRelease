<template>
    <q-btn @click="clickMedia" class="overflow-hidden" style="width:50px"
        :class="{ 'is-tool-selected': isSelectedMedia }">
...
import { addImage, addVideo, addAudio, addUrl } from '../../js/toolbar/media'
